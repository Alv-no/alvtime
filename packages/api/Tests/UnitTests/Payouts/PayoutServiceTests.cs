...
namespace Tests.UnitTests.Payouts
{
    public class PayoutServiceTests
    {
        ...
        public void RegisterPayout_WorkingOvertimeAfterPayout_OnlyConsiderOvertimeWorkedBeforePayout()
        {
            ...
            var timeEntry5 = CreateTimeEntryWithCompensationRate(new DateTime(2021, 12, 15), 2M, 0.5M, out _); //Wednesday
            ...
            var availableHoursAtPayoutDate = timeRegistrationService.GetAvailableOvertimeHoursAtDate(new DateTime(2021, 12, 14));
            ...
            var availableHoursAfterPayoutDate = timeRegistrationService.GetAvailableOvertimeHours();
