...
namespace AlvTime.Persistence.Migrations
{
    ...
    [Migration("20260520110403_User_Add_LastSwitchedSalaryModel")]
    partial class User_Add_LastSwitchedSalaryModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlvTime.Persistence.DatabaseModels.VDataDump", b =>
                {
                    ...
                    b.ToView("V_DataDump", (string)null);
                });
            ...
            modelBuilder.Entity("AlvTime.Persistence.ProjectFavorites", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AlvTime.Persistence.ProjectFavorites", b =>
                {
                    b.HasOne("AlvTime.Persistence.DatabaseModels.Project", "Project")
