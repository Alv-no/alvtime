...
from Task
         ...
         inner join (select HourRate.taskid, HourRate.rate, "hours".id as hourId
                     from HourRate
                              inner join "hours"
                                         on "hours".taskid = HourRate.taskid and "hours".Date >= HourRate.FromDate
                              inner join (select HourRate.taskId, max(FromDate) as FromDate, "hours".id as hourId
                                          from HourRate
                                                   inner join "hours"
                                                              on "hours".taskid = HourRate.taskid and "hours".Date >= HourRate.FromDate
                                          group by HourRate.taskId, "hours".id) maxHours
                                         on maxHours.taskid = HourRate.taskid and
                                            maxHours.FromDate = HourRate.FromDate and
                                            "hours".id = maxHours.hourId) HourR
                    on HourR.taskid = task.id and "hours".id = HourR.hourId
GO
...
ALTER TABLE [dbo].[Customer]
    ADD DEFAULT ('') FOR [InvoiceAddress]
GO
ALTER TABLE [dbo].[Customer]
...
ALTER TABLE [dbo].[User]
    ADD DEFAULT ('') FOR [StartDate]
GO
ALTER TABLE [dbo].[AccessTokens]
    WITH CHECK ADD CONSTRAINT [FK_AccessTokens_User] FOREIGN KEY ([UserId])
        REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[EmploymentRate]
    WITH CHECK ADD CONSTRAINT [FK_EmploymentRate_User] FOREIGN KEY ([UserId])
        REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[CompensationRate]
    WITH CHECK ADD CONSTRAINT [FK_CompensationRate_Task] FOREIGN KEY ([TaskId])
        REFERENCES [dbo].[Task] ([Id])
GO
ALTER TABLE [dbo].[CompensationRate]
    CHECK CONSTRAINT [FK_CompensationRate_Task]
GO
ALTER TABLE [dbo].[AccessTokens]
    CHECK CONSTRAINT [FK_AccessTokens_User]
GO
ALTER TABLE [dbo].[AssociatedTasks]
    WITH CHECK ADD CONSTRAINT [FK_AssociatedTasks_Task] FOREIGN KEY ([TaskId])
        REFERENCES [dbo].[Task] ([Id])
GO
ALTER TABLE [dbo].[AssociatedTasks]
    CHECK CONSTRAINT [FK_AssociatedTasks_Task]
GO
ALTER TABLE [dbo].[AssociatedTasks]
    WITH CHECK ADD CONSTRAINT [FK_AssociatedTasks_User] FOREIGN KEY ([UserId])
        REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[AssociatedTasks]
    CHECK CONSTRAINT [FK_AssociatedTasks_User]
GO
ALTER TABLE [dbo].[HourRate]
    WITH CHECK ADD CONSTRAINT [FK_HourRate_Task] FOREIGN KEY ([TaskId])
        REFERENCES [dbo].[Task] ([Id])
GO
ALTER TABLE [dbo].[HourRate]
    CHECK CONSTRAINT [FK_HourRate_Task]
GO
ALTER TABLE [dbo].[hours]
    WITH CHECK ADD CONSTRAINT [FK_hours_Task] FOREIGN KEY ([TaskId])
        REFERENCES [dbo].[Task] ([Id])
GO
ALTER TABLE [dbo].[hours]
    CHECK CONSTRAINT [FK_hours_Task]
GO
ALTER TABLE [dbo].[hours]
    WITH CHECK ADD CONSTRAINT [FK_hours_User] FOREIGN KEY ([User])
        REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[hours]
    CHECK CONSTRAINT [FK_hours_User]
GO
ALTER TABLE [dbo].[PaidOvertime]
    WITH CHECK ADD CONSTRAINT [FK_PaidOvertime_User] FOREIGN KEY ([User])
        REFERENCES [dbo].[User] ([Id])
GO
ALTER TABLE [dbo].[PaidOvertime]
...
GO
ALTER TABLE [dbo].[Task]
    WITH CHECK ADD CONSTRAINT [FK_Task_Project] FOREIGN KEY ([Project])
        REFERENCES [dbo].[Project] ([Id])
GO
ALTER TABLE [dbo].[Task]
    CHECK CONSTRAINT [FK_Task_Project]
GO
ALTER TABLE [dbo].[TaskFavorites]
    WITH CHECK ADD CONSTRAINT [FK_TaskFavorites_Task] FOREIGN KEY ([TaskId])
        REFERENCES [dbo].[Task] ([Id])
GO
ALTER TABLE [dbo].[TaskFavorites]
    CHECK CONSTRAINT [FK_TaskFavorites_Task]
GO
ALTER TABLE [dbo].[TaskFavorites]
    WITH CHECK ADD CONSTRAINT [FK_TaskFavorites_User] FOREIGN KEY ([UserId])
        REFERENCES [dbo].[User] ([Id])
GO
...
GO
EXEC sys.sp_addextendedproperty @name=N'microsoft_database_tools_support', @value=N'refactoring log',
     @level0type=N'SCHEMA', @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'__RefactorLog'
GO
EXEC sys.sp_addextendedproperty @name=N'microsoft_database_tools_support', @value=1, @level0type=N'SCHEMA',
     @level0name=N'dbo', @level1type=N'TABLE', @level1name=N'sysdiagrams'
GO