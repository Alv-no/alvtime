	...
	{#if isEditingTask}
		...
		>
			<div class="rounded border-2 justify-center align-center border-blue-500">
				<iconify-icon class="text-blue-500" width="1.5em" icon="pajamas:pencil" />
			</div>
		</button>
		<!-- Default - NOT EDITING -->
	{:else}
		...
		>
			<div class="rounded border-2 justify-center align-center border-transparent">
				<iconify-icon width="1.5em" icon="pajamas:pencil" />
			</div>
		</button>
	{/if}
</button>
